...
var _bindata = map[string]func() (*asset, error){
	"assets/generated/swagger/api.swagger.json": assetsGeneratedSwaggerApiSwaggerJson,
}
	...
	"assets": &bintree{nil, map[string]*bintree{
		"generated": &bintree{nil, map[string]*bintree{
			"swagger": &bintree{nil, map[string]*bintree{
				"api.swagger.json": &bintree{assetsGeneratedSwaggerApiSwaggerJson, map[string]*bintree{}},
			}},
		}},
	}},
}}
